...
import { DecodeOptions } from './codec';

export type WorkerRequest = WorkerDecodeRequest | WorkerInitCodecRequest | WorkerDisposeRequest;
...
export type WorkerResponse = WorkerDecodeResult | WorkerDecodeError | WorkerInitResult | WorkerReady;
